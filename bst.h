//
// Created by Daniel Broadby on 15/3/2023.
//
...
//void bst_print_in_order(BST* bst); //ordered function
void bst_print_pre_order(BST* tree); //pre-order function
void bst_print_post_order(BST* tree); //post-order function
